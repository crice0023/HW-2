...
```{=html}
<div id="nsdetohesx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#nsdetohesx table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#nsdetohesx thead, #nsdetohesx tbody, #nsdetohesx tfoot, #nsdetohesx tr, #nsdetohesx td, #nsdetohesx th {
  border-style: none;
}
...
#nsdetohesx .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#nsdetohesx .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#nsdetohesx .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#nsdetohesx .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#nsdetohesx .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#nsdetohesx .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#nsdetohesx .gt_spanner_row {
  border-bottom-style: hidden;
}

#nsdetohesx .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#nsdetohesx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#nsdetohesx .gt_from_md > :first-child {
  margin-top: 0;
}

#nsdetohesx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#nsdetohesx .gt_row_group_first td {
  border-top-width: 2px;
}

#nsdetohesx .gt_row_group_first th {
  border-top-width: 2px;
}

#nsdetohesx .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#nsdetohesx .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#nsdetohesx .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#nsdetohesx .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#nsdetohesx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#nsdetohesx .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#nsdetohesx .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#nsdetohesx .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#nsdetohesx .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#nsdetohesx .gt_font_normal {
  font-weight: normal;
}

#nsdetohesx .gt_font_bold {
  font-weight: bold;
}

#nsdetohesx .gt_font_italic {
  font-style: italic;
}
...
#nsdetohesx .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#nsdetohesx .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#nsdetohesx .gt_indent_1 {
  text-indent: 5px;
}

#nsdetohesx .gt_indent_2 {
  text-indent: 10px;
}

#nsdetohesx .gt_indent_3 {
  text-indent: 15px;
}

#nsdetohesx .gt_indent_4 {
  text-indent: 20px;
}

#nsdetohesx .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
```
Regression analysis for jobs_are_scarce_numeric in DefaultCountry reveals the following significant relationships (p < 0.05):
...
Regression analysis for child_suffers_numeric in DefaultCountry reveals the following significant relationships (p < 0.05):
