---
title: "Country Level Automated Report for Croatia"
output:
  html_document:
...
<caption>Descriptive Summary of Categorical Variables for Croatia</caption>
 <thead>
  <tr>
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;width: 4cm; "> Croatia </td>
...
Table: Descriptive Statistics for Age in Croatia

|     Mean|       SD| Min| 25% Quantile| Median| 75% Quantile| Max|
|--------:|--------:|---:|------------:|------:|------------:|---:|
| 48.91325| 17.70112|  18|           33|     50|           64|  82|
# Sex Impact on Dependent Variables #

### Plot 1 Sex/Jobs are Scarce ###
![](report_Croatia_files/figure-html/jobs-are-scarce-bar-plot-1.png)<!-- -->

### Plot 2 Sex/Child Suffers ###

![](report_Croatia_files/figure-html/child-suffers-sex-bar-plot-1.png)<!-- -->

## Regression Models ##


```{=html}
<div id="ukmvtjyrny" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#ukmvtjyrny table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#ukmvtjyrny thead, #ukmvtjyrny tbody, #ukmvtjyrny tfoot, #ukmvtjyrny tr, #ukmvtjyrny td, #ukmvtjyrny th {
  border-style: none;
}
...
#ukmvtjyrny .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#ukmvtjyrny .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#ukmvtjyrny .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#ukmvtjyrny .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#ukmvtjyrny .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#ukmvtjyrny .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#ukmvtjyrny .gt_spanner_row {
  border-bottom-style: hidden;
}

#ukmvtjyrny .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ukmvtjyrny .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#ukmvtjyrny .gt_from_md > :first-child {
  margin-top: 0;
}

#ukmvtjyrny .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#ukmvtjyrny .gt_row_group_first td {
  border-top-width: 2px;
}

#ukmvtjyrny .gt_row_group_first th {
  border-top-width: 2px;
}

#ukmvtjyrny .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#ukmvtjyrny .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#ukmvtjyrny .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#ukmvtjyrny .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ukmvtjyrny .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#ukmvtjyrny .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ukmvtjyrny .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ukmvtjyrny .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#ukmvtjyrny .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#ukmvtjyrny .gt_font_normal {
  font-weight: normal;
}

#ukmvtjyrny .gt_font_bold {
  font-weight: bold;
}

#ukmvtjyrny .gt_font_italic {
  font-style: italic;
}
...
#ukmvtjyrny .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#ukmvtjyrny .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#ukmvtjyrny .gt_indent_1 {
  text-indent: 5px;
}

#ukmvtjyrny .gt_indent_2 {
  text-indent: 10px;
}

#ukmvtjyrny .gt_indent_3 {
  text-indent: 15px;
}

#ukmvtjyrny .gt_indent_4 {
  text-indent: 20px;
}

#ukmvtjyrny .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
```
Regression analysis for jobs_are_scarce_numeric in Croatia reveals the following significant relationships (p < 0.05):
...
Regression analysis for child_suffers_numeric in Croatia reveals the following significant relationships (p < 0.05):
