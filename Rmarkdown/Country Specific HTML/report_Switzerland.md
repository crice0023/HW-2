...
Regression analysis for child suffers numeric in Switzerland reveals the following significant relationships (p < 0.05):

the intercept has a positive effect (estimate: 2.684 *** )
respondent_sex_recodemale has a negative effect (estimate: -0.074 *** ) 

Regression analysis for jobs are scarce numeric in Switzerland reveals the following significant relationships (p < 0.05):
...
<table style="text-align:center"><caption><strong>Regression Models for Switzerland</strong></caption>
