---
title: "Country Level Automated Report for Sweden"
output:
  html_document:
...
<caption>Descriptive Summary of Categorical Variables for Sweden</caption>
 <thead>
  <tr>
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;width: 4cm; "> Sweden </td>
...
Table: Descriptive Statistics for Age in Sweden

|     Mean|       SD| Min| 25% Quantile| Median| 75% Quantile| Max|
|--------:|--------:|---:|------------:|------:|------------:|---:|
| 51.95394| 18.05395|  18|           37|     54|           68|  82|
# Sex Impact on Dependent Variables #

### Plot 1 Sex/Jobs are Scarce ###
![](report_Sweden_files/figure-html/jobs-are-scarce-bar-plot-1.png)<!-- -->

### Plot 2 Sex/Child Suffers ###

![](report_Sweden_files/figure-html/child-suffers-sex-bar-plot-1.png)<!-- -->

## Regression Models ##


```{=html}
<div id="pypprfnekb" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#pypprfnekb table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#pypprfnekb thead, #pypprfnekb tbody, #pypprfnekb tfoot, #pypprfnekb tr, #pypprfnekb td, #pypprfnekb th {
  border-style: none;
}
...
#pypprfnekb .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#pypprfnekb .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#pypprfnekb .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#pypprfnekb .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#pypprfnekb .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#pypprfnekb .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#pypprfnekb .gt_spanner_row {
  border-bottom-style: hidden;
}

#pypprfnekb .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pypprfnekb .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#pypprfnekb .gt_from_md > :first-child {
  margin-top: 0;
}

#pypprfnekb .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#pypprfnekb .gt_row_group_first td {
  border-top-width: 2px;
}

#pypprfnekb .gt_row_group_first th {
  border-top-width: 2px;
}

#pypprfnekb .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pypprfnekb .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#pypprfnekb .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#pypprfnekb .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pypprfnekb .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pypprfnekb .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pypprfnekb .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pypprfnekb .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#pypprfnekb .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#pypprfnekb .gt_font_normal {
  font-weight: normal;
}

#pypprfnekb .gt_font_bold {
  font-weight: bold;
}

#pypprfnekb .gt_font_italic {
  font-style: italic;
}
...
#pypprfnekb .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#pypprfnekb .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#pypprfnekb .gt_indent_1 {
  text-indent: 5px;
}

#pypprfnekb .gt_indent_2 {
  text-indent: 10px;
}

#pypprfnekb .gt_indent_3 {
  text-indent: 15px;
}

#pypprfnekb .gt_indent_4 {
  text-indent: 20px;
}

#pypprfnekb .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
```
Regression analysis for jobs_are_scarce_numeric in Sweden reveals the following significant relationships (p < 0.05):
...
Regression analysis for child_suffers_numeric in Sweden reveals the following significant relationships (p < 0.05):
