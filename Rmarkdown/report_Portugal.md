---
title: "Country Level Automated Report for Portugal"
output:
  html_document:
...
<caption>Descriptive Summary of Categorical Variables for Portugal</caption>
 <thead>
  <tr>
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;width: 4cm; "> Portugal </td>
  ...
  <tr>
   ...
   <td style="text-align:right;"> 16.5432099 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 4cm; "> jobs_are_scarce </td>
   <td style="text-align:left;width: 4cm; "> no answer </td>
   <td style="text-align:right;"> 5 </td>
   <td style="text-align:right;"> 0.4115226 </td>
  </tr>
</tbody>
</table>
## Table 2 - Continuous Variable Descriptive Statistics ##

Table: Descriptive Statistics for Age in Portugal

|    Mean|       SD| Min| 25% Quantile| Median| 75% Quantile| Max|
|-------:|--------:|---:|------------:|------:|------------:|---:|
| 55.4749| 18.47981|  18|           41|     58|           72|  82|
# Sex Impact on Dependent Variables #

### Plot 1 Sex/Jobs are Scarce ###
![](report_Portugal_files/figure-html/jobs-are-scarce-bar-plot-1.png)<!-- -->

### Plot 2 Sex/Child Suffers ###

![](report_Portugal_files/figure-html/child-suffers-sex-bar-plot-1.png)<!-- -->

## Regression Models ##


```{=html}
<div id="zlhtbmggth" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#zlhtbmggth table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#zlhtbmggth thead, #zlhtbmggth tbody, #zlhtbmggth tfoot, #zlhtbmggth tr, #zlhtbmggth td, #zlhtbmggth th {
  border-style: none;
}
...
#zlhtbmggth .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#zlhtbmggth .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#zlhtbmggth .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#zlhtbmggth .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#zlhtbmggth .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#zlhtbmggth .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#zlhtbmggth .gt_spanner_row {
  border-bottom-style: hidden;
}

#zlhtbmggth .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zlhtbmggth .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#zlhtbmggth .gt_from_md > :first-child {
  margin-top: 0;
}

#zlhtbmggth .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#zlhtbmggth .gt_row_group_first td {
  border-top-width: 2px;
}

#zlhtbmggth .gt_row_group_first th {
  border-top-width: 2px;
}

#zlhtbmggth .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#zlhtbmggth .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#zlhtbmggth .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#zlhtbmggth .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zlhtbmggth .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#zlhtbmggth .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zlhtbmggth .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zlhtbmggth .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#zlhtbmggth .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#zlhtbmggth .gt_font_normal {
  font-weight: normal;
}

#zlhtbmggth .gt_font_bold {
  font-weight: bold;
}

#zlhtbmggth .gt_font_italic {
  font-style: italic;
}
...
#zlhtbmggth .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#zlhtbmggth .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#zlhtbmggth .gt_indent_1 {
  text-indent: 5px;
}

#zlhtbmggth .gt_indent_2 {
  text-indent: 10px;
}

#zlhtbmggth .gt_indent_3 {
  text-indent: 15px;
}

#zlhtbmggth .gt_indent_4 {
  text-indent: 20px;
}

#zlhtbmggth .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
```
Regression analysis for jobs_are_scarce_numeric in Portugal reveals the following significant relationships (p < 0.05):
...
Regression analysis for child_suffers_numeric in Portugal reveals the following significant relationships (p < 0.05):
