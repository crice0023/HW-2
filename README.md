...
## Main Findings
   ...
   **(1) When jobs are scarce national citizens should be hired before immigrants, and (2) A child suffers when a mother works.** 
   ...
   Interested parties that wish to learn more about this project should consider reviewing pdf/html output forms. As previously shown, these can be found in the Rmarkdown folder under HW-2. 
